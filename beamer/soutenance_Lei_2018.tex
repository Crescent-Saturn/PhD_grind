...
\logo{\includegraphics[height=0.5cm]{UL_P}\hspace{.5cm}%
	\includegraphics[height=0.5cm]{lvsn}\hspace{.2cm}\vspace{.85\paperheight}}
...
\begin{frame}[label=titre, plain]
	\titlepage
	\begin{center}\includegraphics[height=1cm]{UL_P}%
		\hspace{2cm}\includegraphics[height=1cm]{lvsn}\end{center}
\end{frame}
